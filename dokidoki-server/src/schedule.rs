...
pub use resolver::{
    at_daily_greeting_fire_time, at_pre_sleep_fire_time, current_custom_slot, current_slot_kind,
    current_wakeup_slot, in_schedule_change_window, upcoming_pre_sleep, CustomSlotStatus,
